...
class GenerosControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create genero" do
    assert_difference('Genero.count') do
      post generos_url, params: { genero: { imagen: @genero.imagen, nombre: @genero.nombre } }, as: :json
    end
  ...
  test "should update genero" do
    patch genero_url(@genero), params: { genero: { imagen: @genero.imagen, nombre: @genero.nombre } }, as: :json
    assert_response 200
  end
